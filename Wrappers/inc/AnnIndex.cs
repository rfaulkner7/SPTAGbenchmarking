...
unsafe { fixed(byte* ptrp_meta = p_meta) { CSHARPSPTAGPINVOKE.WrapperArray tempp_meta = new CSHARPSPTAGPINVOKE.WrapperArray( (System.IntPtr)ptrp_meta, (ulong)p_meta.LongLength );
  ...
  public ResultIterator GetIterator(byte[] p_target) {
unsafe { fixed(byte* ptrp_target = p_target) { CSHARPSPTAGPINVOKE.WrapperArray tempp_target = new CSHARPSPTAGPINVOKE.WrapperArray( (System.IntPtr)ptrp_target, (ulong)p_target.LongLength );
    {
      global::System.IntPtr cPtr = CSHARPSPTAGPINVOKE.AnnIndex_GetIterator(swigCPtr,  tempp_target );
      ResultIterator ret = (cPtr == global::System.IntPtr.Zero) ? null : new ResultIterator(cPtr, true);
      if (CSHARPSPTAGPINVOKE.SWIGPendingException.Pending) throw CSHARPSPTAGPINVOKE.SWIGPendingException.Retrieve();
      return ret;
    }
} }
